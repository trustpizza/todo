...
const projectForm = () => {
    ...
    formWrapper.className = 'w-full h-full fixed hidden bg-gray-200 flex items-center justify-center'
    formWrapper.id = 'newProjectFormWrapper'

    const form = document.createElement('form');
    form.className = "flex flex-col p-4 overflow-x-hidden overflow-y-auto md:inset-0 bg-white shadow-md rounded px-8 pt-6 pb-8 mb-4";
